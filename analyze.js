(function() {
     ...
     // Optionally, place your HTML code here:
     let html = "";
     ...
     function analyzeHTML(text) {
          ...
          console.log("Uses Depcrated Tags:       " + usesDeprecatedTags);
          ...
          console.log("Missing semantic tags:     " + missingSemanticTags);
          ...
          console.log("Missing alt attribute:     " + missingAltAttribute);
          ...
          console.log("Missing lang attribute:    " + missingLangAttribute);
          ...
          console.log("Moving text:               " + movingText);
